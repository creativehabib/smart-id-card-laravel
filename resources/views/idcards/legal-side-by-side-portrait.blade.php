...
<style>
  ...
  .topbar, .back-top{
    height:16mm; background:#fff; display:flex; align-items:center;
  ...
  .photo{ width:30mm; height:36mm; object-fit:cover; border:0.2mm solid #c9c9c9; background:#fff; }
  ...
  .back-bottom{ position:absolute; left:0; right:0; bottom:1.5mm; min-height:16mm; padding:2mm 4mm; border-top:0.3mm solid #e5e5e5; display:flex; align-items:center; justify-content:center; background:#fff; }
            ...
            <tr>
              @foreach($row as $e)
                @php
                  ...
                  $qrDataUri = 'data:image/png;base64,'. base64_encode(QrCode::format('png')->size(180)->margin(0)->generate($qrPayload));
                @endphp
                <td class="pair-cell">
                  <div class="pair-ib">
                    <!-- FRONT -->
                    <div class="card card-ib">
                      ...
                      <div class="bottom">
                        ...
                        <div class="qr"><img src="{{ $qrDataUri }}" style="width:18mm;height:18mm;"></div>
